...
export const Astrology = () => {
    ...
    const CallData = async () => {
        let promise = await fetch(`${BASE_URL}&q=astrology`);
    ...
    return (
        <MainNewsContainerStyle>
            ...
            <div style={{ display: "flex", alignItems: "center", marginBottom: "20px" }}>
                <div className='headingLineDiv' style={{ width: "66%" }}>
                    <div className='headingLine'></div>
                    <div className='headingLine'></div>
                    <div className='headingLine'></div>
                </div>

                <div style={{ fontSize: "20px", fontWeight: "bold", textAlign: "center", width: "50%" }}><span className='bracketHome'>[</span>ASTROLOGY<span className='bracketHome'>]</span></div>
