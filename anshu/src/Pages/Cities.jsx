...
export const Cities = () => {
    ...
    const CallData = async()=>{
        let promise = await fetch("https://newsapi.org/v2/everything?q=Cities&apiKey=10ebb6b783bd45c78d28d7fdb43628ad");
            ...
            if(count===1){
                return(
                    <div className='MainNewsFirstDiv'>
                            <div className='pointer MainNewsFirstH2'>CITIES NEWS</div>
                ...
                return(
                    <MainNewsDiv className='MainNewsDiv'>
                        <div>
                            <MainNewsH2 className='pointer'>CITIES NEWS</MainNewsH2>
